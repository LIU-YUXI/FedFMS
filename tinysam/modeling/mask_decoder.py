...
class MaskDecoder(nn.Module):
    ...
    def forward(
        ...
        # print(self.num_classes,masks.shape)
        # Prepare output
    ...
    def predict_masks(
        ...
        # tokens = torch.cat((output_tokens, sparse_prompt_embeddings), dim=1) # 要把sparseprompt删掉
        ...
        src = src# + dense_prompt_embeddings # denseprompt删掉
