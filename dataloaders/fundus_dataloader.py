...
class Dataset(Dataset):
    ...
    def __init__(self,data_path=None, client_idx=None, freq_site_idx=None, split='train', transform=None):
        ...
        if split=='train':
            data_path = data_path if data_path is not None else '/CIS43/Medical_Images/FeTS2022_FedDG'
    ...
    def __getitem__(self, idx):
        ...
        # image_patch=cv2.resize(image_patch, (384,384), interpolation=cv2.INTER_LINEAR)
        # mask_patch=cv2.resize(mask_patch, (384,384), interpolation=cv2.INTER_NEAREST)
