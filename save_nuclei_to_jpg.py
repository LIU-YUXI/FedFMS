...
# 输入和输出文件夹路径
def save(data_name):
	data_input_folder = "/mnt/diskB/lyx/Nuclei_1024/{}/data_npy/".format(data_name)
	data_output_folder = "/mnt/diskB/lyx/Nuclei_1024_JPG/{}/data_npy/".format(data_name)

	label_input_folder = "/mnt/diskB/lyx/Nuclei_1024/{}/label_npy/".format(data_name)
	label_output_folder = "/mnt/diskB/lyx/Nuclei_1024_JPG/{}/label_npy/".format(data_name)
